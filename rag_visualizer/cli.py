"""CLI entry point for RAG Visualizer."""
...
@click.version_option(package_name="rag-visualizer")
def main(port: int, host: str) -> None:
    """Launch the RAG Visualizer Streamlit application.
    ...
    from rag_visualizer.services.storage import ensure_storage_dir
    ...
    click.echo(f"Starting RAG Visualizer on http://{host}:{port}")
